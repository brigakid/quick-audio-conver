const steps = [
  ...
  },
  {
    ...
    description:
      'After upload, all available output formats for your file are shown automatically. Select MP3, WAV, M4A, FLAC, AAC, OGG, or OPUS. For MP3, AAC, OGG, and OPUS, choose your preferred bitrate — 128, 192, or 320 kbps.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
