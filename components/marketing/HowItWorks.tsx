const steps = [
  {
    ...
    description:
      'Drag and drop your file onto the converter, or click to browse. Accepts 17 formats including MP4, MOV, WAV, FLAC, ALAC, M4A, MP3, AAC, OGG, AIFF, AMR, AC3, WMA, and Opus — up to 200 MB.',
    icon: (
  ...
  },
  {
    ...
    description:
      'After upload, all available output formats are shown automatically. Select MP3, WAV, M4A, FLAC, AAC, OGG, or OPUS and choose your bitrate. Optional tools also appear: BPM detection and tempo change, key detection and pitch shifting, and trim/fade.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
