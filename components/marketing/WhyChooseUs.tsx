const features = [
  ...
  {
    title: '12 Input Formats, 3 Outputs',
    description:
      'Accepts MP4, WAV, M4A, FLAC, MP3, AAC, OGG, AIFF, WMA, Opus, OGA, and WEBA. Converts to MP3, WAV, or M4A. Available outputs are shown automatically based on what you upload.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
