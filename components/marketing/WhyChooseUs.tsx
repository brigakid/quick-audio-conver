const features = [
  ...
  {
    title: '12 Input Formats, 7 Outputs',
    description:
      'Accepts MP4, WAV, M4A, FLAC, MP3, AAC, OGG, AIFF, WMA, Opus, OGA, and WEBA. Converts to MP3, WAV, M4A, FLAC, AAC, OGG, or OPUS. Available outputs are shown automatically based on what you upload.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
